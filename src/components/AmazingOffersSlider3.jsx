    ...
    <div className="px-8">
      <section className="max-w-[1526px] mx-auto mt-8 border rounded-2xl border-[#C6CEDE] overflow-hidden">
        ...
        <div className="bg-white p-2 relative">
          ...
          {/* HEADER */}
          <div className="flex items-center justify-between mb-4 h-15 bg-red-900 rounded-lg " dir="rtl">
            <button className="flex items-center gap-2 text-sm text-gray-300 hover:text-white font-bold pr-6" dir="rtl">
              نمایش همه
              <FiChevronLeft />
            </button>
          </div>
